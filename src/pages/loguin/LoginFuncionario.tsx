...
export default function LoginFuncionario() {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        if (!ok) {
          setErros({
            geral:
              'Credenciais inválidas. Verifique seu ID e senha ou entre em contato com o RH.',
          })
        } else {
    ...
    [form, validar, loginFuncionario, navigate]
  )
    ...
    <div className="lg-page lg-page--func">
      <div className="lg-card">
        <div className="lg-header">
          ...
          <h1 className="lg-header__title">Área do Funcionário</h1>
